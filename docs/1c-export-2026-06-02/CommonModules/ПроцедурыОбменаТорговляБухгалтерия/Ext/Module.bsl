...
Процедура ДополнитьМассивУзловДляВыгрузкиДокумента(Элемент, МассивУзловДляПередачи, 
	...
	ИначеЕсли ТипЭлемента = Тип("ДокументСсылка.АккредитивПереданный")
		...
		ИЛИ ТипЭлемента = Тип("ДокументСсылка.ПлатежноеТребованиеПоручениеВыставленное")
		ИЛИ ТипЭлемента = Тип("ДокументОбъект.ПлатежноеТребованиеПоручениеВыставленное")
		ИЛИ ТипЭлемента = Тип("ДокументСсылка.ПлатежноеТребованиеПоручениеПолученное")
		ИЛИ ТипЭлемента = Тип("ДокументОбъект.ПлатежноеТребованиеПоручениеПолученное")
		...
		ИЛИ ТипЭлемента = Тип("ДокументСсылка.ЗаписьКнигиПриобретения")
		ИЛИ ТипЭлемента = Тип("ДокументОбъект.ЗаписьКнигиПриобретения")
		ИЛИ ТипЭлемента = Тип("ДокументСсылка.НалоговаяНакладная")
		ИЛИ ТипЭлемента = Тип("ДокументОбъект.НалоговаяНакладная")
		ИЛИ ТипЭлемента = Тип("ДокументСсылка.Приложение1КНалоговойНакладной")
		ИЛИ ТипЭлемента = Тип("ДокументОбъект.Приложение1КНалоговойНакладной")
		ИЛИ ТипЭлемента = Тип("ДокументСсылка.Приложение2КНалоговойНакладной")
		ИЛИ ТипЭлемента = Тип("ДокументОбъект.Приложение2КНалоговойНакладной")
	...
	Если НЕ (
		...
		ИЛИ ТипЭлемента = Тип("ДокументСсылка.СчетНаОплатуПоставщика")
		ИЛИ ТипЭлемента = Тип("ДокументОбъект.СчетНаОплатуПоставщика")
		ИЛИ ТипЭлемента = Тип("ДокументСсылка.ЗаказПокупателя")
		ИЛИ ТипЭлемента = Тип("ДокументОбъект.ЗаказПокупателя")
		ИЛИ ТипЭлемента = Тип("ДокументСсылка.ЗаказПоставщику")
		ИЛИ ТипЭлемента = Тип("ДокументОбъект.ЗаказПоставщику")
		ИЛИ ТипЭлемента = Тип("ДокументСсылка.ЗаписьКнигиПриобретения")
		ИЛИ ТипЭлемента = Тип("ДокументОбъект.ЗаписьКнигиПриобретения")
		ИЛИ ТипЭлемента = Тип("ДокументСсылка.НалоговаяНакладная")
		ИЛИ ТипЭлемента = Тип("ДокументОбъект.НалоговаяНакладная")
