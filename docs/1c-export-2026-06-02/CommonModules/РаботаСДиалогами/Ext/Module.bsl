...
Процедура ОбработатьПризнакОтраженияВреглУчетеДляФормы(Объект, Форма,ИмяОтражатьВБУ = "ОтражатьВБухгалтерскомУчете",ИмяОтражатьВНУ = "ОтражатьВНалоговомУчете",мОтражатьВРегламентированномУчете) Экспорт
	...
	Если ИмяОтражатьВНУ<>"" Тогда
		Форма.ЭлементыФормы[ИмяОтражатьВНУ].Доступность = Объект.ОтражатьВБухгалтерскомУчете И мОтражатьВРегламентированномУчете;
	КонецЕсли;
...
// Процедура открывает форму обработки "Выгрузка данных в конфигурацию "Бухгалтерия предприятия", ред 1.0"
// для выгрузки в базовую версию.
Процедура ОткрытьФормуОбработкиВыгрузкаДанныхВ1СБухгалтерию81_10ВБазовуюВерсию() Экспорт
	
	ОбработкаОбъект = Обработки.ВыгрузкаДанныхВ1СБухгалтерию81_10.Создать();
...
// Процедура открывает форму обработки "Выгрузка данных в конфигурацию "Бухгалтерия предприятия", ред 1.1"
// для выгрузки в базовую версию.
Процедура ОткрытьФормуОбработкиВыгрузкаДанныхВ1СБухгалтерию81_11ВБазовуюВерсию() Экспорт
	
	ОбработкаОбъект = Обработки.ВыгрузкаДанныхВ1СБухгалтерию81_11.Создать();
	ОбработкаОбъект.БазоваяВерсия = Истина;
	ФормаОбработки = ОбработкаОбъект.ПолучитьФорму();
	ФормаОбработки.Открыть();
