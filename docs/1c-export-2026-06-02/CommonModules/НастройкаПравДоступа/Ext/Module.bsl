...
Функция ПолучитьПараметрыПроверкиДокумента(ДокументОбъект)
	...
	ПараметрыПроверкиДокумента.Вставить("ЕстьОперативныйУчет",		(МетаданныеДокумента.Реквизиты.Найти("ОтраженоВОперУчете") <> Неопределено));
	...
	Если ПараметрыПроверкиДокумента.ЕстьОперативныйУчет Тогда
		ПараметрыПроверкиДокумента.Вставить("ПроверятьУправленческуюДатуЗапрета", 		(НЕ ПараметрыПроверкиДокумента.ЕстьОрганизация) или (ДокументОбъект["ОтраженоВОперУчете"]));
	Иначе 
