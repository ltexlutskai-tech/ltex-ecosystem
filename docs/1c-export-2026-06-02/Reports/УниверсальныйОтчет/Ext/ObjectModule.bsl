...
Процедура УстановитьНачальныеНастройкиПоМетаданнымРегистра(ИмяРегистра)
	...
	Если ИмяРегистра = "ТоварыНаСкладах" Тогда
		ОписаниеИтогиЗапросаПостроитель = ОписаниеИтогиЗапросаПостроитель + "," + "
		|	" + "Штрихкод";	
	...
	Если мМассивПоляГруппировка <> Неопределено Тогда
		...
		Для каждого ПолеГруппировка из мМассивПоляГруппировка Цикл
			...
			Если ИмяРегистра = "ТоварыНаСкладах" И ПолеГруппировка.Имя = "Штрихкод" Тогда 
				Продолжить;
			КонецЕсли;	
	...
	|	НачалоПериода(ИсточникДанных.Период, Год) КАК ПериодГод" + ?(ИмяРегистра = "ТоварыНаСкладах", ",
	...
	Если ИмяРегистра = "ТоварыНаСкладах" Тогда
		ОписаниеИсточниковЗапроса =	ОписаниеИсточниковЗапроса + "
		|ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.Штрихкоды КАК Штрихкоды
		|ПО ИсточникДанных.Номенклатура = Штрихкоды.Владелец
		|	И ИсточникДанных.ХарактеристикаНоменклатуры = Штрихкоды.ХарактеристикаНоменклатуры		
