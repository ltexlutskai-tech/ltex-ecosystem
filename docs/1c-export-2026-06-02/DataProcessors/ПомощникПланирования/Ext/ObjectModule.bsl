			...
			Для каждого СтрокаСоставаПлана из ЗаполняемыйДокумент.СоставПлана Цикл
				...
				Если КонечныйПлан.Сценарий.УчетПоСуммам Тогда
					...
					Если КонечныйПлан.Сценарий.УчетПоКоличеству И СтрокаСоставаПлана.Количество <> 0 Тогда 
						...
						СтрокаСоставаПлана.Цена = Ценообразование.ПересчитатьЦенуПриИзмененииФлаговНалогов(СтрокаСоставаПлана.Сумма / СтрокаСоставаПлана.Количество, Неопределено, Истина, ЗаполняемыйДокумент.УчитыватьНДС, ЗаполняемыйДокумент.СуммаВключаетНДС, НалоговыйУчет.ПолучитьСтавкуНДС(СтрокаСоставаПлана.СтавкаНДС));
