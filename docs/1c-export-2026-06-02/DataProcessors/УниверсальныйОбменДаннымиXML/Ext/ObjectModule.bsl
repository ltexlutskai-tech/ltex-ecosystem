...
Процедура ВыгрузитьОбработчикиСобытий(Отказ) Экспорт
	...
	#Если Клиент Тогда
		Если ЭтоИнтерактивныйРежим Тогда
			...
			Если ФлагОшибки Тогда
				Предупреждение(НСтр("ru='При выгрузке обработчиков были обнаружены ошибки.';uk=' При вивантаженні оброблювачів були виявлені помилки.'"));
				
			Иначе
				
				Предупреждение(НСтр("ru='Обработчики успешно выгружены.';uk='Оброблювачі успішно вивантажені.'"));
			КонецЕсли;
...
Процедура ИнициализацияСообщений()
	...
	одСообщения.Вставить(12, НСтр("ru='Не указано имя файла с правилами обмена (Имя файла правил)';uk=""Не зазначене ім'я файлу із правилами обміну (Ім'я файлу правил)"""));
	...
	одСообщения.Вставить(19, НСтр("ru='Ошибка в обработчике события ПередЗагрузкойОбъекта';uk='Помилка в оброблювачі події ПередЗагрузкойОбъекта'"));
	одСообщения.Вставить(20, НСтр("ru='Ошибка в обработчике события ПриЗагрузкеОбъекта';uk='Помилка в оброблювачі події ПриЗагрузкеОбъекта'"));
	одСообщения.Вставить(21, НСтр("ru='Ошибка в обработчике события ПослеЗагрузкиОбъекта';uk='Помилка в оброблювачі події ПослеЗагрузкиОбъекта'"));
	одСообщения.Вставить(22, НСтр("ru='Ошибка в обработчике события ПередЗагрузкойДанных (конвертация)';uk='Помилка в оброблювачі події ПередЗагрузкойДанных (конвертація)'"));
	одСообщения.Вставить(23, НСтр("ru='Ошибка в обработчике события ПослеЗагрузкиДанных (конвертация)';uk='Помилка в оброблювачі події ПослеЗагрузкиДанных (конвертація)'"));
	...
	одСообщения.Вставить(27, НСтр("ru='Ошибка в обработчике события ПередОбработкойПравилаОчистки';uk='Помилка в оброблювачі події ПередОбработкойПравилаОчистки'"));
	одСообщения.Вставить(28, НСтр("ru='Ошибка в обработчике события ПослеОбработкиПравилаОчистки';uk='Помилка в оброблювачі події ПослеОбработкиПравилаОчистки'"));
	одСообщения.Вставить(29, НСтр("ru='Ошибка в обработчике события ПередУдалениемОбъекта';uk='Помилка в оброблювачі події ПередУдалениемОбъекта'"));
	
	одСообщения.Вставить(31, НСтр("ru='Ошибка в обработчике события ПередОбработкойПравилаВыгрузки';uk='Помилка в оброблювачі події ПередОбработкойПравилаВыгрузки'"));
	...
	одСообщения.Вставить(34, НСтр("ru='Ошибка в обработчике события ПослеВыгрузкиОбъекта';uk='Помилка в оброблювачі події ПослеВыгрузкиОбъекта'"));
	...
	одСообщения.Вставить(42, НСтр("ru='Ошибка в обработчике события ПриВыгрузкеОбъекта';uk='Помилка в оброблювачі події ПриВыгрузкеОбъекта'"));
	одСообщения.Вставить(43, НСтр("ru='Ошибка в обработчике события ПослеВыгрузкиОбъекта';uk='Помилка в оброблювачі події ПослеВыгрузкиОбъекта'"));
			
	одСообщения.Вставить(45, НСтр("ru='Не найдено правило конвертации объектов';uk=""Не знайдене правило конвертації об'єктів"""));
		
	одСообщения.Вставить(48, НСтр("ru='Ошибка в обработчике события ПередОбработкойВыгрузки группы свойств';uk='Помилка в оброблювачі події ПередОбработкойВыгрузки групи властивостей'"));
	...
	одСообщения.Вставить(52, НСтр("ru='Ошибка в обработчике события ПослеВыгрузки (объекта коллекции)';uk=""Помилка в оброблювачі події ПослеВыгрузки (об'єкта колекції)"""));
	...
	одСообщения.Вставить(54, НСтр("ru='Ошибка в глобальном обработчике события ПослеЗагрузкиОбъекта (конвертация)';uk='Помилка в глобальному оброблювачі події ПослеЗагрузкиОбъекта (конвертація)'"));
	...
	одСообщения.Вставить(57, НСтр("ru='Ошибка в обработчике события ПослеВыгрузки (свойства)';uk='Помилка в оброблювачі події ПослеВыгрузки (властивості)'"));
	...
	одСообщения.Вставить(63, НСтр("ru='Ошибка в обработчике события ПослеВыгрузкиДанных (конвертация)';uk='Помилка в оброблювачі події ПослеВыгрузкиДанных (конвертація)'"));
	...
	одСообщения.Вставить(65, НСтр("ru='Ошибка в глобальном обработчике события ПередВыгрузкойОбъекта (конвертация)';uk='Помилка в глобальному оброблювачі події ПередВыгрузкойОбъекта (конвертація)'"));
	...
	одСообщения.Вставить(77, НСтр("ru='Не указан файл внешней обработки с подключаемыми процедурами обработчиков событий.';uk='Не зазначений файл зовнішньої обробки з процедурами, що підключають оброблювачі подій.'"));
...
"и повторите выгрузку.';uk='Код алгоритмів не може бути інтегрований в оброблювач через виявлений рекурсивний виклик алгоритмів. "
