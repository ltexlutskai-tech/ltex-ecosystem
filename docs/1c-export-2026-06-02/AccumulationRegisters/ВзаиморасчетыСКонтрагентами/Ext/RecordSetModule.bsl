...
Процедура ПриЗаписи(Отказ, Замещение)
	//Попытка
	//	ОбменАндроид.ЗарегистрироватьОбъектОбменАндроид(ЭтотОбъект.Отбор.Регистратор.Значение.Контрагент);
	//Исключение
	//КонецПопытки;
...
Процедура ПередЗаписью(Отказ, Замещение)
	...
	УдалениеЗаписей = Ложь;	
	Если Не ЭтотОбъект.Количество() Тогда 
		
		УдалениеЗаписей = Истина;
	...
	Для Каждого Элемент Из ЭтотОбъект Цикл 
		...
		ОбменАндроид.ЗарегистрироватьОбъектОбменАндроид(Элемент.Контрагент);
		
	КонецЦикла;
	
	
	Если УдалениеЗаписей Тогда 
		ЭтотОбъект.Очистить();
	КонецЕсли;
