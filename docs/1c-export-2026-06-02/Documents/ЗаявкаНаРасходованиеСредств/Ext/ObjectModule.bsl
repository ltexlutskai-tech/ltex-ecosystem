...
Функция ПечатьЗаявки() Экспорт
	...
	Обл.Параметры.ЗаголовокЗаявки=ОбщегоНазначения.СформироватьЗаголовокДокумента(ЭтотОбъект, НСтр("ru='Заявка на расходование средств';uk='Заявка на витрату коштів'",КодЯзыкаПечать),КодЯзыкаПечать)
