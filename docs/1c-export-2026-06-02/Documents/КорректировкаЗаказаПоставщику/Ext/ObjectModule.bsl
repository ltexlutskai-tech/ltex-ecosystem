...
Функция ПечатьДокумента()
	...
	ОбластьМакета.Параметры.ТекстЗаголовка = ОбщегоНазначения.СформироватьЗаголовокДокумента(Шапка, НСтр("ru='Корректировка заказа поставщику';uk='Коректування замовлення постачальнику'",КодЯзыкаПечать),КодЯзыкаПечать);
