...
Функция ПечатьДокумента()
	...
	|	КорректировкаСерийИХарактеристикТоваров.Организация КАК Поставщик,
	...
	ОбластьМакета.Параметры.ТекстЗаголовка = ОбщегоНазначения.СформироватьЗаголовокДокумента(Шапка, НСтр("ru='Корректировка серий и характеристик товаров';uk='Коректування серій та характеристик товарів'",КодЯзыкаПечать),КодЯзыкаПечать);
