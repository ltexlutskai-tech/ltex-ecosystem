...
#КонецЕсли
	...
	ПараметрыПечати.Вставить("ТекстЗаголовка", ОбщегоНазначения.СформироватьЗаголовокДокумента(Шапка, НСтр("ru='Приходный ордер на товары';uk='Прибутковий ордер на товари'",КодЯзыкаПечать),КодЯзыкаПечать));
	...
	ПредставлениеПокупателя = ФормированиеПечатныхФорм.ОписаниеОрганизации(СведенияОПокупателе, "ПолноеНаименование,");	
	...
	ПараметрыПечати.Вставить("ПредставлениеПокупателя", ПредставлениеПокупателя);	
	...
	//подписи
	ПараметрыПечати.Вставить("Получил", Шапка.Получил);
	...
	Пока ВыборкаСтрокТовары.Следующий() Цикл		
		...
		ПараметрыПозиции.Вставить("ЕдиницаМест", ВыборкаСтрокТовары.ЕдиницаМест);
