...
export const createSaleSchema = z.object({
  ...
  npStreetRef: z.string().max(120).nullable().optional(),
  npStreetName: z.string().max(160).nullable().optional(),
  npBuildingNumber: z.string().max(40).nullable().optional(),
  npFlat: z.string().max(40).nullable().optional(),
