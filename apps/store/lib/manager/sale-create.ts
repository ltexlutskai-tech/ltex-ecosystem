  ...
  const sale = await prisma.$transaction(async (tx) => {
    const created = await tx.sale.create({
      data: {
        ...
        npStreetRef: input.npStreetRef ?? null,
        npStreetName: input.npStreetName ?? null,
        npBuildingNumber: input.npBuildingNumber ?? null,
        npFlat: input.npFlat ?? null,
        ...
        declaredValueMode: input.declaredValueMode ?? null,
