...
import { ClientFilterPicker } from "../../orders/_components/client-filter-picker";

export function SalesToolbar({
  cityOptions = [],
  agentOptions = [],
}: {
  /** Довідник міст для фільтра (щоб уникнути опечаток). */
  cityOptions?: string[];
    ...
    <div className="space-y-3 rounded-lg border bg-white p-3">
      ...
      {clientCode1C && (
        <div className="flex items-center gap-2 rounded-md bg-blue-50 px-3 py-2 text-sm text-blue-700">
          ...
          <button
            type="button"
            onClick={() => setParams({ clientCode1C: null, clientName: null })}
