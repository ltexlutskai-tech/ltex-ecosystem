...
/**
 * Пікер «місто + відділення Нової Пошти» для форми реалізації.
 *
 * Заміняє вільний ввід «№ відділення НП» на структурований вибір із довідника
 * НП — щоб Фаза 1 могла авто-створити ТТН за реф-ами (`cityRef`/`warehouseRef`).
 *
